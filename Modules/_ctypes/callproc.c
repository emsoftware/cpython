...
static PyObject *py_dyld_shared_cache_contains_path(PyObject *self, PyObject *args)
{
    ...
    if (__builtin_available(macOS 11.0, iOS 14.0, tvOS 14.0, watchOS 7.0, *)) {
...
#if 1
        // PyUnicode_FSConverter() isn't available in 2.7
        // (it was introduced in 3.1), so use "z" to get
        // a C-string or NULL (for None) pointer instead.
        ...
        // "O" gets the object without any conversion.
